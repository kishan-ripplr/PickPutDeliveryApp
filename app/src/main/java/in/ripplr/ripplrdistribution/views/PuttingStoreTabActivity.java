...
public class PuttingStoreTabActivity extends CustomFontActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_putting_store_tab);
        ...
        adapter.addFragment(new PuttingStorePendingFragment(), "Pending");
        adapter.addFragment(new PuttingStorePendingFragment(), "Completed");
        ...
        setUpUI();
        setUpBackBtn();
        setActivityTitle("Putting","Store");
